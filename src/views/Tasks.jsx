...
import { CheckCircle, ListTodo, Upload, FileText, Loader2, Award } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {isLoading ? (
          ...
          <div className="text-center p-12 bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500">Check back later for new bounties!</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {tasks.map(task => (
              <div key={task.id} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col relative overflow-hidden">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 mt-4">{task.title}</h3>
                ...
                {task.submissionStatus === 'pending' ? (
                  ...
                  <div className="mt-auto space-y-3 pt-4 border-t border-gray-50">
                    ...
                    <label className="block text-xs font-semibold text-gray-700">Submit Proof (Google Drive URL, Image Link, etc.)</label>
                    <div className="flex gap-2">
                      ...
                      >
                        {submittingTaskId === task.id && !proofUrl ? 'Submit' : <Upload className="w-4 h-4" />}
                      </button>
                    </div>
                  </div>
                )}
